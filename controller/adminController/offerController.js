...
exports.getOffers = async (req, res) => {
    try {
        ...
        console.log(categories,"categoies in add offer")
...
exports.addOffer = async (req, res) => {
    try {
        ...
        const newOffer = new offerModel({
            ...
            offerType,
            applicableProduct: offerType === 'products' ? applicableProduct : null,
...
exports.editOffer = async (req, res) => {
    try {
        ...
        const updatedData = {
            ...
            applicableProduct: req.body.offerType === 'products' ? req.body.applicableProduct : null,
